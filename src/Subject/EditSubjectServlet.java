 ...
 */
@WebServlet(urlPatterns = {"/editSubject", "/suaMonHoc"})
public class EditSubjectServlet extends HttpServlet {
            ...
            throws ServletException, IOException 
    {
        ...
        try {
            ...
            request.setAttribute("web_title","Sửa Môn Học");
            request.setAttribute("web_content","Subject/editSubject.jsp");
