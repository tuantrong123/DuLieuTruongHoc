 ...
 */
@WebServlet(urlPatterns = {"/subject", "/Subject", "/monhoc"})
public class SubjectServlet extends HttpServlet {
            ...
            throws ServletException, IOException 
    {
        ...
        try {
            ...
            request.setAttribute("DataTotal",MonHoc.Pagination(pageSize,page));
            request.setAttribute("DataTable",MonHoc.List(pageSize,count,b));
            request.setAttribute("web_title","Môn Học");
            request.setAttribute("web_content","Subject/Subject.jsp");
