 ...
 */
@WebServlet(urlPatterns = {"/addSubject", "/themMonHoc"})
...
//           out.close();
        ...
        request.setAttribute("web_title","Thêm Môn Học"); // Tá»±a Ä‘á»? Web
        request.setAttribute("web_content","Subject/addSubject.jsp"); // Ná»™i dung Web
            ...
            throws ServletException, IOException 
    {
        ...
        try 
        {
            ...
            data.put(2, NameSubject);
            
            // ThÃªm má»›i dÃ²ng báº£n ghi vÃ o CSDL
            MonHoc.Add(data);
            
            HttpSession session = request.getSession();
            session.setAttribute("SUCCESS_MSG", "Thêm thành công!");
