 ...
 */
@WebServlet(urlPatterns = {"/detailsClass", "/chitietClass"})
public class DetailsClassServlet extends HttpServlet {
            ...
            throws ServletException, IOException 
    {
        ...
        try {
            ...
            request.setAttribute("web_title","Chi tiết lớp");
            request.setAttribute("web_content","Class/detailsClass.jsp");
