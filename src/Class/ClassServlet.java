 ...
 */
@WebServlet(urlPatterns = {"/class", "/Class", "/lophoc"})
public class ClassServlet extends HttpServlet {
            ...
            throws ServletException, IOException 
    {
        ...
        try {
            ...
            request.setAttribute("DataTotal",Lop.Pagination(pageSize,page));
            request.setAttribute("DataTable",Lop.List(pageSize,count,b));
            request.setAttribute("web_title","Lớp Học");
            request.setAttribute("web_content","Class/Class.jsp");
