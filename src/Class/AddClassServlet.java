 ...
 */
@WebServlet(urlPatterns = {"/addClass", "/themLop"})
...
//           out.close();
        ...
        request.setAttribute("web_title","Thêm Lớp Học"); // Tá»±a Ä‘á»? Web
        request.setAttribute("web_content","Class/addClass.jsp"); // Ná»™i dung Web
            ...
            throws ServletException, IOException 
    {
        ...
        try 
        {
            ...
            data.put(1, ClassId);
            data.put(2, NameClass);
            
            // ThÃªm má»›i dÃ²ng báº£n ghi vÃ o CSDL
            Lop.Add(data);
            
            HttpSession session = request.getSession();
            session.setAttribute("SUCCESS_MSG", "Thêm lớp mới thành công!");
