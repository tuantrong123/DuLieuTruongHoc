 ...
 */
@WebServlet(urlPatterns = {"/editResult", "/suaResult"})
public class EditResultServlet extends HttpServlet {
            ...
            throws ServletException, IOException 
    {
        ...
        try {
            ...
            request.setAttribute("Data",KetQuaThi.Details(ResultID));
            request.setAttribute("web_title","Sửa Kết Quả");
