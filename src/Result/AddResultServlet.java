 ...
 */
@WebServlet(urlPatterns = {"/addResult", "/themResult"})
public class AddResultServlet extends HttpServlet {
            ...
            throws ServletException, IOException 
    {
        ...
        try {
        	...
        	request.setAttribute("DataSubject",MonHoc.List(pageSize, count, keywork));
        	request.setAttribute("web_title","Thêm Kết Quả Thi");
            request.setAttribute("web_content","Result/addResult.jsp");
            ...
            throws ServletException, IOException 
    {
        ...
        try 
        {
            ...
            session.setAttribute("SUCCESS_MSG", "Thêm mới thành công!");
