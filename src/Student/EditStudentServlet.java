 ...
 */
@WebServlet(urlPatterns = {"/editStudent", "/suaSinhVien"})
public class EditStudentServlet extends HttpServlet {
            ...
            throws ServletException, IOException 
    {
        ...
        try {
            ...
            request.setAttribute("Data",SinhVien.Details(StudentID));
            request.setAttribute("web_title","Sửa Sinh Viên");
            request.setAttribute("web_content","Student/editStudent.jsp");
