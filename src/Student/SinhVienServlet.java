 ...
 */
@WebServlet(urlPatterns = {"/student", "/Student", "/sinhvien"})
public class SinhVienServlet extends HttpServlet {
            ...
            throws ServletException, IOException 
    {
        ...
        try {
            ...
            request.setAttribute("DataTotal",SinhVien.Pagination(pageSize,page));
            request.setAttribute("DataTable",SinhVien.List(pageSize,count,b));
            request.setAttribute("web_title","Sinh Viên");
            request.setAttribute("web_content","Student/Student.jsp");
