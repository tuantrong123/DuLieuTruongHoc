...
<a class="text-light text-decoration-none" href="/Student">Danh Sách Lớp Học</a>
</button>

<form method="post" class="g-3" action="/detailsStudent?StudentID=${Data.StudentID}">
	<div class="bg-light p-4">
		<h4 class = "text-center">Chi Tiết Sinh Viên</h4>
