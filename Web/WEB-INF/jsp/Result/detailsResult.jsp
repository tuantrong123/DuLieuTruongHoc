...
<a class="text-light text-decoration-none" href="/Result">Danh Sách Lớp Học</a>
</button>

<form method="post" action="/detailsResult?ResultID=${Data.ResultID}">
	<div class="bg-light p-4">
		<h4 class = "text-center">Chi tiết Kết Quả Thi</h4>
